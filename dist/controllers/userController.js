...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.registration = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, role, code, findcode, candidate, hashPassword, user, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, email = _a.email, password = _a.password, role = _a.role, code = _a.code;
                        return [4 /*yield*/, models_1.OneTimeCode.findOne({ where: { code: code } })];
                    case 1:
                        findcode = _b.sent();
                        if (!findcode) {
                            return [2 /*return*/, res.status(400).json({ message: "Такого кода не существует" })];
                        }
                        if (!email || !password) {
                            return [2 /*return*/, res
                                    .status(400)
